...
Route::group(['middleware'=>['checklog','web']],function(){
	...
	Route::group(['prefix' => 'trabajo','middleware'=>['filtro_user']],function(){
		...
		Route::get('/lista', 'ControladorTrabajo@listaDeTrabajo');
		Route::get('/{id}/informacion', 'ControladorTrabajo@informacionTrabajo');	
	});
	...
	Route::group(['prefix' => 'tipoTrabajo','middleware'=>['filtro_admin']],function(){
