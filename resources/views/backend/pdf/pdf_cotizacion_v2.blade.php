...
?>
	...
	<div class="container">
		<div class="col col-lg-8 col-lg-push-2">
				<div class="well">
					<legend>TPM Ingeniería E.I.R.L.</legend>
				...
				<table class="table">
					...
					<tbody>
						...
						<td>{{$cont}}</td>	
						<td>{{$it->nombre}}</td>
						<td>{{$it->pivot->cantidad}}</td>
						<td>{{$it->pivot->precio_unitario}}</td>
						<td>{{$it->pivot->cantidad * $it->pivot->precio_unitario}}</td>
						</tr>
						<?php
						$cont++;
						$total = $total+ $it->pivot->cantidad * $it->pivot->precio_unitario ;
						?>
						@endforeach
						<tr>
						<td>{{$cont}}</td>	
				...
				<table >
					...
					<tbody>
						...
						<td>.........</td>
						<td>........................</td>
						<td><b>{{$total + $cotizacion->gasto_fijo}}</b></td>
					</tbody>
				</table>
				</div>
			</div>
